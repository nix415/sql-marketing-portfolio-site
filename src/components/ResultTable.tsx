...
export default function ResultTable({ table }: { table: ResultTableT }) {
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-[color:var(--color-line)] bg-[color:var(--color-surface)]/60">
      <div className="px-4 py-2.5 text-[11px] uppercase tracking-[0.2em] text-[color:var(--color-muted)] border-b border-[color:var(--color-line)] bg-[color:var(--color-surface)] flex items-center gap-2">
